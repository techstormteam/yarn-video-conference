/**
 * Implements API class that embeds Yarn Videochat in external applications.
 */
var JitsiMeetExternalAPI = (function()
{
    /**
     * The minimum width for the Yarn Videochat frame
     * @type {number}
     */
    var MIN_WIDTH = 790;

    /**
     * The minimum height for the Yarn Videochat frame
     * @type {number}
     */
    var MIN_HEIGHT = 300;
    ...
    /**
     * Sends the passed object to Yarn Videochat
    ...
    /**
     * Adds event listeners to Yarn Videochat. The object key should be the name of the
    ...
    /**
     * Adds event listeners to Yarn Videochat. Currently we support the following
     * events:
     * incomingMessage - receives event notifications about incoming
     * messages. The listener will receive object with the following structure:
     * {{
    ...
    /**
     * Processes message events sent from Yarn Videochat
    ...
    /**
     * That method is called when the Yarn Videochat is loaded. Executes saved
    ...
    /**
     * Setups the listener for message events from Yarn Videochat.
     */
    ...
    /**
     * Removes the listeners and removes the Yarn Videochat frame.
     */
