...
var Toolbar = (function (my) {
        ...
        if (!Moderator.isModerator()) {
            if (sharedKey) {
                messageHandler.openMessageDialog(null,
                        "This Yarn Videochat is currently protected by" +
                        " a password. Only the owner of the Yarn Conference" +
                        " could set a password.",
                    false,
                    "Password");
            } else {
                messageHandler.openMessageDialog(null,
                    "This Yarn Videochat isn't currently protected by" +
                        " a password. Only the owner of the Yarn Conference" +
                        " could set a password.",
                    false,
                    "Password");
            ...
            if (sharedKey) {
                ...
                messageHandler.openTwoButtonDialog(null,
                    '<h2>Set a password to lock your Yarn Videochat room</h2>' +
    ...
    my.openLinkDialog = function () {
        ...
        if (roomUrl === null) {
            inviteLink = "Your Yarn Videochat room is currently being created...";
        } else {
            inviteLink = "http://yarn-me.com/videochat/?room="+conferenceName;
        }
        messageHandler.openTwoButtonDialog(
            "Share this link with everyone you want to invite to this Yarn Videochat",
    ...
    function inviteParticipants() {
        ...
        if (sharedKey && sharedKey.length > 0) {
            sharedKeyText =
                "This Yarn Videochat is password protected. Please use the " +
                "following pin when joining:%0D%0A%0D%0A" +
                sharedKey + "%0D%0A%0D%0A";
        }

        var conferenceName = roomUrl.substring(roomUrl.lastIndexOf('/') + 1);
        var subject = "Invitation to a Yarn Videochat (" + conferenceName + ")";
        var body = "Hey there, I%27d like to invite you to a Yarn Videochat" +
                    ...
                    "%0D%0A%0D%0A" +
                    sharedKeyText +
                    "Note that Yarn Videochat is currently" +
